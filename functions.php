...
function woocom_scripts() {
	...
	wp_enqueue_style( 'woocom-main', get_template_directory_uri().'/css/main.css', array(), _S_VERSION );
	wp_enqueue_style( 'woocom-icons', 'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css');
	...
	wp_enqueue_script('woocom-script', get_template_directory_uri().'js/script.js', array('jquery'));
...
function enqueue_custom_fonts() {
	if(!is_admin()){
		wp_register_style('source_sans_N_nunito','https://fonts.googleapis.com/css2?family=Nunito:wght@400;700&family=Source+Sans+Pro:wght@400;600;700&display=swap');
		wp_enqueue_style('source_sans_N_nunito');
	}
}
 ...
 */
 ...
 function custom_footer_widget_one(){
	$args = array (
		...
		'descriptions'  => __('Column One', 'text_domain'),
...
function custom_footer_widget_two(){
	$args = array (
		...
		'descriptions'  => __('Column Two', 'text_domain'),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h3 class="title">',
		'after_title'	=> '</h3>',
...
function custom_footer_widget_three(){
	$args = array (
		...
		'descriptions'  => __('Column Three', 'text_domain'),
		'before_widget'	=> '<div id="%1$s" class="widget %2$s">',
		'after_widget'	=> '</div>',
		'before_title'	=> '<h3 class="title">',
		'after_title'	=> '</h3>',
  ...
  */
  ...
  function wp_enqueue_commerce_styles() {
